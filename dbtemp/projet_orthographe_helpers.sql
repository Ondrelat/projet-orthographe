...
CREATE TABLE `helpers` (
  ...
  `idWord` int DEFAULT NULL,
  `Name` varchar(45) DEFAULT NULL,
  `Description` longtext,
  `TypeHelper` varchar(45) DEFAULT NULL,
  `nombreVote` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `idWord_idx` (`idWord`),
  CONSTRAINT `idWord` FOREIGN KEY (`idWord`) REFERENCES `words` (`id`)
